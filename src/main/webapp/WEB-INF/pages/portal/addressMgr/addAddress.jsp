        ...
        <div class="loginPage retisterPage">
            ...
            <div class="login">
                <div class="login_itemBox" style="margin-bottom: 0;">
                    <form action="<%=basePath%>address/ajaxAdd" method="post" id="addForm">
                        <div class="login_item">
                            <input type="text" name="inceptPeople" id="inceptPeople" value="" class="lo_input" placeholder="收货人姓名">
                        </div>
                        <div class="login_item">
                            <input type="tel" name="inceptTel" id="inceptTel" value="" class="lo_input" maxlength="11" placeholder="11位手机号码 ">
                        </div>
                        <div class="login_item">
                            <input type="text" name="provinceCityRegion" value="" class="lo_input chocieCity" id="chocieAllCity" maxlength="11" placeholder="请选择地区 " readonly="readonly">
                            <input type="hidden" id="city_id0" name="province"/>
                            <input type="hidden" id="city_id1" name="city"/>
                            <input type="hidden" id="city_id2" name="region"/>
                            <input type="hidden" id="city_text0" name="provinceText"/>
                            <input type="hidden" id="city_text1" name="cityText"/>
                            <input type="hidden" id="city_text2" name="regionText"/>
                        </div>
<%--                        <div class="login_item">--%>
<%--                            <textarea name="tbAddressPO.streetAddress" rows="3" cols="123" id="streetAddress" class="lo_input cmTarea" valid="{must:true, fieldType:'pattern',regex:'',tip:'街道信息'}" placeholder="街道门牌详细信息"></textarea>--%>
<%--                        </div>--%>
                        <div class="login_item">
                        ...
                        <div class="setDeafultAddressForm">
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="hidden" id="addressType" name="addressType" value="0" />
                                </dd>
                            </dl>
                        </div>
