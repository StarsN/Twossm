...
<%
    ...
    System.out.print("在orderPay页面获取到的orderId=" + orderId);
...
<%--            </li>--%>
    ...
    <div class="mbtn">
        <a href="javascript:;" class="btn_finish" onclick="rightPay()">立即付款</a>
    </div>
</div>
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.code == "0") {
                    ...
                    setTimeout(function () {
                        window.location.href = "<%=basePath%>order/returnOrderCancelPage?orderId=" + $("#orderId").val();
                    }, 1000)
                }
            }
        })
