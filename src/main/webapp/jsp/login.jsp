...
<script type="text/javascript">
    ...
    //从而每次都生成一个新的验证码对象
    function loadImage(){
        document.getElementById("code").src = "<%=basePath%>jsp/image.jsp?"+Math.random();
    }
</script>
...
<div class="login">
    <div class="login-main">
        <div class="login-top">
            ...
            <h1>用户登录</h1>
            <form action="<%=basePath%>login/loginCheck" id="form" method="post">
                ...
                <img src="<%=basePath%>jsp/image.jsp"  height="30px" id="code"  onClick="javascript:loadImage();"/>
                ...
                没有账号？<a href="<%=basePath%>login/returnRegisterPage">注册</a>
            </form>
        </div>
    </div>
</div>
